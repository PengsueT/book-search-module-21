...
import { SAVE_BOOK } from "../utils/mutations"; // Import for a GraphQL mutation to save a book to the DB
...
const SearchBooks = () => {
  ...
  const handleSaveBook = async (bookId) => {
    ...
    try {
      const { data } = await saveBook({ // Saving the book to a users library in the DB
        variables: {
          bookData: {
